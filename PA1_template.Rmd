...
The **mean** of the total number of steps taken per day equals **`r sum_day_mean_imputed`** and the **median** of the total number of steps taken per day equals **`r sum_day_median_imputed`**. Only the new median estimate for the total daily number of steps differs slightly from the non-imputed data median (`r sum_day_median`), the mean is the same as before imputation, as would be expected after imputing the mean. Overall, the imputation appears to have reduced the variance of the distribution making it more leptokurtic.
