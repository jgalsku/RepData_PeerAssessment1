...
The **mean** of the total number of steps taken per day equals **`r sum_day_mean_imputed`** and the **median** of the total number of steps taken per day equals **`r sum_day_median_imputed`**. The new estimates for the total daily number of steps differ slightly from the non-imputed data estimates, with a larger difference between the means than between the medians.
